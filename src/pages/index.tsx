      ...
      <div className="max-w-7xl mx-auto pt-24 sm:px-8 md:px-6 mt-16 px-4 sm:mt-24">
        <div className="text-center">
          ...
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Strangers Hub is the perfect platform to express yourself without
            the fear of being judged. With our easy-to-use interface, you can
            anonymously share your thoughts, opinions, and stories with the
            world. Join us today and let your voice be heard - without ever
